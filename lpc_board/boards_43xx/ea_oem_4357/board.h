...
//
int CheckUpdateTouch(int *);
void Board_LcdBackLightCtrl(int prop);
void RTS_Control(void);
...
int ChipEepWrite(int pgno, void *buf, int nr);
void ChipEepInit();	
//
//
//
extern RTC_TIME_T _rtc_get, _rtc_set;
extern void RTC_SetTimeUTC(uint32_t utc);
