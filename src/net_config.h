...
#define HTTP_TRACE_LEVEL         TRACE_LEVEL_OFF   // 요청 폴링 스팸 억제
...
#define SNTP_TRACE_LEVEL         TRACE_LEVEL_WARNING
#define NTP_TRACE_LEVEL          TRACE_LEVEL_WARNING
#define NTS_TRACE_LEVEL          TRACE_LEVEL_INFO
#define TFTP_TRACE_LEVEL         TRACE_LEVEL_INFO
#define MODBUS_TRACE_LEVEL       TRACE_LEVEL_WARNING
...
#if 1	// 2025-3-25, for Proxy Server
	//Default buffer size for transmission
	#define TCP_DEFAULT_TX_BUFFER_SIZE (1430*8)
	//Default buffer size for reception
	#define TCP_DEFAULT_RX_BUFFER_SIZE (1430*8)
#else
	//Default buffer size for transmission
