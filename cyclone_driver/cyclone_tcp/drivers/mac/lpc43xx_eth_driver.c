...
//LPC4330-Xplorer or LPCXpresso4337 evaluation board?
   ...
   LPC_SCU->SFSP0_1  = SCU_SFSP0_0_EZI_Msk  | SCU_SFSP0_1_EHS_Msk  | (6 & SCU_SFSP0_1_MODE_Msk);
...
#if 1	// SMI, GPIO(0.12)
	LPC_SCU->SFSP1_17 = SCU_SFSP1_17_EZI_Msk | SCU_SFSP1_17_EPUN_Msk | (0 & SCU_SFSP1_17_MODE_Msk);	// mode 0
	LPC_GPIO_PORT->DIR[0] |= (1<<12);
#else	
   LPC_SCU->SFSP1_17 = SCU_SFSP1_17_EZI_Msk |                        (3 & SCU_SFSP1_17_MODE_Msk);
#endif	
   //Configure P1.18 (ENET_TXD0)
   LPC_SCU->SFSP1_18 = SCU_SFSP1_18_EZI_Msk | SCU_SFSP1_18_EHS_Msk | (3 & SCU_SFSP1_18_MODE_Msk);
   ...
   LPC_SCU->SFSP1_20 = SCU_SFSP1_20_EZI_Msk | SCU_SFSP1_20_EHS_Msk | (3 & SCU_SFSP1_20_MODE_Msk);   
   //Configure PC.1 (ENET_MDC)
#if 1	// SMI, GPIO(6.0)
	LPC_SCU->SFSPC_1 =                                                (4 & SCU_SFSPC_1_MODE_Msk);   // mode 4
	LPC_GPIO_PORT->DIR[6] |= (1<<0);
#else
   LPC_SCU->SFSPC_1 = SCU_SFSPC_1_EHS_Msk                          | (3 & SCU_SFSPC_1_MODE_Msk);   
#endif	
#else
   //Configure P0.0 (ENET_RXD1)
   LPC_SCU->SFSP0_0 = SCU_SFSP0_0_EZI_Msk   | SCU_SFSP0_0_EHS_Msk  | (2 & SCU_SFSP0_0_MODE_Msk);
