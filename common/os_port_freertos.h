...
#ifndef OS_TASK_PRIORITY_LLOW
#if 1
   #define OS_TASK_PRIORITY_LLOW (tskIDLE_PRIORITY + 1)
#else
   #define OS_TASK_PRIORITY_LLOW (tskIDLE_PRIORITY + 1)
#endif   
#endif
...
//Task priority (low)
#ifndef OS_TASK_PRIORITY_LOW
#if 1
   #define OS_TASK_PRIORITY_LOW (tskIDLE_PRIORITY + 2)
#else
   #define OS_TASK_PRIORITY_LOW (tskIDLE_PRIORITY + 1)
#endif   
#endif
...
#if 1
   #define OS_TASK_PRIORITY_NORMAL (tskIDLE_PRIORITY + 3)
#else
...
#if 1
   #define OS_TASK_PRIORITY_HIGH (tskIDLE_PRIORITY + 4)
#else
...
#ifndef OS_TASK_PRIORITY_HHIGH
#if 1
   #define OS_TASK_PRIORITY_HHIGH (tskIDLE_PRIORITY + 5)
#else
   #define OS_TASK_PRIORITY_HHIGH (tskIDLE_PRIORITY + 2)
#endif   
#endif
