...
//Task priority (low low)
   ...
   #define OS_TASK_PRIORITY_LLOW 1
#endif

//Task priority (low)
#ifndef OS_TASK_PRIORITY_LOW
   #define OS_TASK_PRIORITY_LOW 2
#endif
...
//Task priority (high high)
   ...
   #define OS_TASK_PRIORITY_HHIGH 5
#endif

// REALTIME 추가
//Task priority (high high)
#ifndef OS_TASK_PRIORITY_REALTIME
   #define OS_TASK_PRIORITY_REALTIME 6
#endif
...
// Thread Flag, 2025-3-26, cskang
void osThreadFlagsSet(OsTaskId tid, uint16_t flags);
bool_t osThreadFlagsWait(uint16_t flags, uint16_t timeout);
OsTaskId osThreadGetId();
